...
using BeerTapHypermedia.WebApi.Infrastructure.Installers;
using BeerTapHypermedia.Model;
using IQ.Platform.Framework.WebApi.Infrastructure;

namespace BeerTapHypermedia.WebApi.Infrastructure
{
    ...
    public class DefaultApiContainer : ApiContainer
    {
        ...
        {
            return
                _windsorContainer.Resolve<ApiSecurityContextProvidingHandler<BeerTapHypermediaApiUser, NullUserContext>>();
        }
